                                ...
                                <div class="col-md-12">
                                    <input id="name" type="text" class="form-control
                                        @error('name') is-invalid @enderror" name="name"
                                           value="{{ $event->name }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col-md-12">
                                    <input id="team1name" type="text" class="form-control
                                         @error('team1name') is-invalid @enderror" name="team1name"
                                           value="{{ $event->team1name }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col-md-12">
                                    <input id="team2name" type="text" class="form-control
                                       @error('team2name') is-invalid @enderror" name="team2name"
                                           value="{{ $event->team2name }}" required autocomplete="team2name" autofocus>
